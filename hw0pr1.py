...
print("Ten is", factorial(4) / (sqrt(4) * sqrt(4)) +4)
...
print("Sixteen is", (4+ sqrt(4) * sqrt(4)) * sqrt(4))
print("Seventeen is", 4*4 + 4/4)
print("Eighteen is", factorial(4) - sqrt(4) - sqrt(4) - sqrt(4))
print("Nineteen is", factorial(4) -4 - 4/4)
print("Twenty is", factorial(int(sqrt(4) * sqrt(4))) - sqrt(4) * sqrt(4))